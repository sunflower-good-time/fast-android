package com.yixia.base.arch.view;
...
import com.yixia.base.arch.model.BaseDataSource;
 ...
 * @date 2019/10/29
 */
public abstract class BaseFragment<VM extends BaseViewModel, ViewBinding extends ViewDataBinding> extends Fragment implements ILoaded {
